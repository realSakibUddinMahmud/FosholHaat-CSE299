...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: TOKENS.color.textStrong, fontSize: 28, fontWeight: "800", letterSpacing: -0.9 },
  tabRow: {
    flexDirection: "row",
  ...
  cardTitle: { color: TOKENS.color.textStrong, fontSize: 18, fontWeight: "800", letterSpacing: -0.4 },
  ...
  sheetTitle: { flex: 1, color: TOKENS.color.textStrong, fontSize: 20, fontWeight: "800", letterSpacing: -0.5 },
