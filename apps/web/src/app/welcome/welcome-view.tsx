        ...
        <AuthCard>
          <div className={styles.panelCard}>
            ...
            <div className={styles.stack}>
              <Link href="/login" className={styles.cta}>{copy.welcome.login}</Link>
              <Link href="/signup/role" className={`${styles.cta} ${styles.ctaSecondary}`}>{copy.welcome.createAccount}</Link>
            </div>
            <p className={styles.footerText}>
              <Link href="/language" className={styles.footerLink}>{copy.welcome.chooseLanguage}</Link>
            </p>
          </div>
        </AuthCard>
      }
